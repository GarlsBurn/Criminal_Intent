...
class CrimeFragment: Fragment(), DatePickerFragment.Callbacks, TimePickerFragment.Callbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        crimeDetailViewModel = ViewModelProvider(
            this,
            CrimeDetailViewModel.CrimeDetailViewModelFactory(crimeId)
    ...
    override fun onCreateView(
        ...
        if (!::photoFile.isInitialized) {
            photoFile = File(requireContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES), "IMG_${UUID.randomUUID()}.jpg")
        }
            ...
            Observer{ crime ->
                crime?.let {
                    ...
                    photoUri = FileProvider.getUriForFile(requireActivity(),
                        ...
                        photoFile)
                    Log.d(TAG, "Файл фото: ${photoFile.path}, существует: ${photoFile.exists()}")
                    updateUI()
                }
            })
    }
